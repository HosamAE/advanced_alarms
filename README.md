...
**A powerful, self-contained productivity module for Odoo 18**

[![Odoo Version](https://img.shields.io/badge/Odoo-18.0-875A7B?style=flat-square&logo=odoo)](https://www.odoo.com)
...
**Advanced Alarms & Time Management** brings a complete time management suite directly into Odoo's interface. Built from the ground up for Odoo 18 with OWL 2 components, it provides a rich systray experience with real-time notifications, customisable sounds, and intelligent data retention — all without any external dependencies.
...
### v18.0.1.0.0 — June 2026 (Initial Release)
